...
export const heritageVowsGallery = [
...
export const heritageVowsWishes = [
  {
    name: "Khánh & Vy",
    message:
...
export function HeritageVowsHeader({ tier }: { tier: string }) {
...
export function HeritageVowsMusicPlayer({
  label,
  accentClassName,
}: {
  label: string;
...
export function HeritageVowsFallingHearts({ color }: { color: string }) {
  return (
    <>
      <style jsx global>{`
        @keyframes falling-heart-heritage-vows {
          0% {
      ...
      <div className="pointer-events-none absolute inset-0 z-10 overflow-hidden" aria-hidden="true">
        {heartParticles.map((heart, index) => (
          <span
            ...
            style={{
              left: heart.left,
              animationName: "falling-heart-heritage-vows",
